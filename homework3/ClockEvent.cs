...
namespace c1
{
    ...
    public class AlarmClock
    {
        ...
        public void Run()
        {
            ...
            Console.WriteLine($"闹钟将会在10秒后结束({alarmTime.ToString("HH:mm:ss")}).");
            DateTime tmpTime;
    ...
    public class Form
    {
        ...
        {
            Console.WriteLine($"现在的时间是 {args.CurrentTime.ToString("HH:mm:ss")}");
        }

        void Clock_OnAlarm(object sender, AlarmEventArgs args)
        {
            Console.WriteLine($"时间到，现在的时间是 {args.AlarmTime.ToString("HH:mm:ss")}");
        }
    }
    class ClockEvent
    {
